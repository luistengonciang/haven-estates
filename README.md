...
Current release: Vanguard `vanguard-chat` Edge Function version 30 is active in Supabase. The repository's latest release commit is kept on the `main` branch.
